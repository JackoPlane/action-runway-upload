...
/**
 * Get the default glob options
 * @see https://github.com/actions/upload-artifact/blob/4cec3d8aa04e39d1a68397de0c4cd6fb9dce8ec1/src/shared/search.ts#L14
 * @param includeHiddenFiles Whether to include hidden files
 * @returns The default glob options
 */
 ...
 *
 * @see https://github.com/actions/upload-artifact/blob/4cec3d8aa04e39d1a68397de0c4cd6fb9dce8ec1/src/shared/search.ts#L32
